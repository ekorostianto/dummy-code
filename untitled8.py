# -*- coding: utf-8 -*-
"""
Created on Wed Aug 18 18:21:18 2021
...
data = pd.read_csv(r'D:\College\Semester8\data\analisa\zonal_statistics\IndexGDSI.csv', sep=';')
a = np.array(data)
ewh=a.reshape(11,12)
...
fig, ax = plt.subplots()
ax.set_title('Indeks Kekeringan GDSI 2005-2015 \n Basin Bengawan Solo dan Brantas')
...
sns.heatmap(ewh, linewidths=.5, cmap=("Oranges_r"), xticklabels=x_axis_labels, yticklabels=y_axis_labels)
